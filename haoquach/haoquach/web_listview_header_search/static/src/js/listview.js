...
SearchView.include({
    build_search_data: function () {
        var res = this._super();
        // console.log('tgl_domain', this.tgl_domain);
...
ListRenderer.include({
    ...
    tgl_build_search_domain: function() {
        ...
        console.log('tgl_domain', tgl_domain);
    ...
    _renderHeader: function (isGrouped) {
        ...
        var $tr = $('<tr>')
        var $tr_search = $('<tr>')
            .append(_.map(this.columns, this._renderSearchHeaderCell.bind(this)));
    ...
    _renderSearchHeaderCell: function (node) {
        ...
        if (field.sortable == false) {
            return res.append(`<form>
            <div class="tgl_search_header_container">
                <input class="tgl_search_header o_input" readonly style="background-color: #eee" type="text" id="${name}" value="${value}" data-name="${name}"/>
            </div></form>`);
        }
        ...
        res.append(`<form>
            <div class="tgl_search_header_container">
                <input class="tgl_search_header o_input" type="text" placeholder="Search..." id="${name}" value="${value}" data-name="${name}"/>
            </div></form>`
        );
        ...
        if (type == 'datetime' || type == 'date') {
            ...
            $tgl_search_header_container.append(
                `<input class="tgl_range_search_header o_input" placeholder="Search..." type="text" value="${value}" data-name="${name}"/>`
            );
